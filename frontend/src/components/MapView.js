  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '20px', color: '#2c3e50' }}>
        ...
        {selectedBus && (
          <span style={{ fontSize: '1rem', color: '#666', marginLeft: '15px' }}>
      ...
      <div style={{
        ...
        <strong> Buses:</strong> {Object.keys(buses).length} | 
          ...
          >
            <Popup>
              <div style={{ minWidth: '150px', textAlign: 'center' }}>
                ...
                <p><strong>{stop.busName}</strong></p>
                  ...
                  <Popup>
                    <div style={{ minWidth: '220px' }}>
                      <h3 style={{ 
                        ...
                        🚌 {bus.name}
                        {isSelected && <span style={{color: '#856404', fontSize: '12px', marginLeft: '10px'}}>SELECTED</span>}
                      </h3>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '10px' }}>
                        ...
                        <div>
                          <span style={{
                            ...
                            fontSize: '12px',
                            backgroundColor: 
                              bus.status === 'moving' ? '#d4edda' :
                              bus.status === 'stopped' ? '#f8d7da' :
                              bus.status === 'decelerating' ? '#fff3cd' :
                              '#e2e3e5',
                            color: 
                              bus.status === 'moving' ? '#155724' :
                              bus.status === 'stopped' ? '#721c24' :
                              bus.status === 'decelerating' ? '#856404' :
                              '#383d41'
                          }}>
                            {bus.status}
                          </span>
